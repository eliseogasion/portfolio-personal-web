...
export default function ProjectCard({ project, onSelect }: ProjectCardProps) {
  return (
    ...
    >
      {/* Visual Canvas */}
      <div className="relative aspect-[16/10] w-full rounded-xl overflow-hidden bg-zinc-950 border border-white/10 mb-4 group-hover:border-white/30 transition-colors">
        <Image
      ...
      <div className="flex flex-col flex-grow">
        ...
        <h3 className="text-lg font-semibold text-white group-hover:text-zinc-300 transition-colors tracking-tight mb-1.5 flex items-center justify-between">
